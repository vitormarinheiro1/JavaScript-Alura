...
console.log(nome, idade, maiorDeIdade)
...
const sobrenome = 'Marinheiro'
const sobrenomeDoMeio = 'Rodrigues'
const ultimoSobrenome = 'Silva'

console.log(primeiroNome, sobrenome + sobrenomeDoMeio, `${ultimoSobrenome}`)
